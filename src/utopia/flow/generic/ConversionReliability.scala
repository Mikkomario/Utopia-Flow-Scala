...
object ConversionReliability
{
	 ...
	 * (1.23 -> 1).
	 */
    case object DATA_LOSS extends ConversionReliability(23)
    /**
	 ...
	 * ("2015" -> false)
	 */
    case object MEANING_LOSS extends ConversionReliability(47)
    /**
	 ...
	 */
    case object DANGEROUS extends ConversionReliability(56)
